...
namespace proyecto_tesis_api.Controllers
{
    ...
    public class TipoClienteController : ControllerBase
    {
        ...
        // POST api/<Controller>
        [HttpPost]
        public ActionResult Post([FromBody] TipoCliente r)
        {
        ...
        [HttpPut("{id}")]
        public ActionResult Put(string id, [FromBody] TipoCliente r)
        {
            try
            {
                if (r is null)
